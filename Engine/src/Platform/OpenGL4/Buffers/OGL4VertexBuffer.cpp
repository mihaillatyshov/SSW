...
namespace LM
{
    ...
    OGL4VertexBuffer::~OGL4VertexBuffer() { glDeleteBuffers(1, &m_BufferID); }

    void OGL4VertexBuffer::Bind() const { glBindBuffer(GL_ARRAY_BUFFER, m_BufferID); }

    void OGL4VertexBuffer::Unbind() const { glBindBuffer(GL_ARRAY_BUFFER, 0); }
