...
namespace LM
{
    ...
    uint32_t OGL4FrameBuffer::GetTextureFormat() { return 0; }

    uint32_t OGL4FrameBuffer::GetTextureAttach() { return 0; }
    ...
    {
        // CORE_ASSERT(glCheckNamedFramebufferStatus(m_BufferID, GL_FRAMEBUFFER) == GL_FRAMEBUFFER_COMPLETE,
        ...
        switch (glCheckNamedFramebufferStatus(m_BufferID, GL_FRAMEBUFFER))
        {
            ...
            case GL_FRAMEBUFFER_INCOMPLETE_ATTACHMENT:
                CORE_ASSERT(false, "FRAMEBUFFER: GL_FRAMEBUFFER_INCOMPLETE_ATTACHMENT");
                break;
            case GL_FRAMEBUFFER_INCOMPLETE_MISSING_ATTACHMENT:
                CORE_ASSERT(false, "FRAMEBUFFER: GL_FRAMEBUFFER_INCOMPLETE_MISSING_ATTACHMENT");
                break;
            case GL_FRAMEBUFFER_INCOMPLETE_DRAW_BUFFER:
                CORE_ASSERT(false, "FRAMEBUFFER: GL_FRAMEBUFFER_INCOMPLETE_DRAW_BUFFER");
                break;
            case GL_FRAMEBUFFER_INCOMPLETE_READ_BUFFER:
                CORE_ASSERT(false, "FRAMEBUFFER: GL_FRAMEBUFFER_INCOMPLETE_READ_BUFFER");
                break;
            case GL_FRAMEBUFFER_INCOMPLETE_MULTISAMPLE:
                CORE_ASSERT(false, "FRAMEBUFFER: GL_FRAMEBUFFER_INCOMPLETE_MULTISAMPLE");
                break;
            case GL_FRAMEBUFFER_INCOMPLETE_LAYER_TARGETS:
                CORE_ASSERT(false, "FRAMEBUFFER: GL_FRAMEBUFFER_INCOMPLETE_LAYER_TARGETS");
                break;
        }
    }
    ...
    void OGL4FrameBuffer::Unbind() const { glBindFramebuffer(GL_FRAMEBUFFER, 0); }
    ...
    void OGL4FrameBuffer::Clear(glm::vec4 _Color) const
    {
        ...
        {
            glClearNamedFramebufferfv(m_BufferID, GL_COLOR, i, glm::value_ptr(_Color));
        }
